...
<body>
	<div style="height:400px;width:400px;margin-top:10%;margin-left:30%;border:1px solid red;">
			<form class="form-horizontal form" role="form" method="post" action="<?php echo U('check');?>">
   <div class="form-group">
	...
	<div>
		...
		<div class="col-sm-5">
			<input type="text" class="form-control" id="yzm"  name="verify"
				placeholder="请输入验证码">
		</div>
		<div class="col-sm-5">
...
<script>
	$("#verify").click(function(){
		$(this).attr("src","<?php echo U('verify');?>"+"?random="+Math.random())
	})
</script>
</body>
